...
public class GeetestLib {
	 ...
	 * SDK版本名称
	 */
	protected final String verName = "2.15.11.17.1";
	 ...
	 * @return
	 */
	public int privatePreProcess() {
		// just check the server side register
		if (privateRegisterChallenge() != 1) {
			return 0;
		}
	 ...
	 * @return
	 */
	protected int getGtServerStatus() {
	 ...
	 * @return
	 */
	protected int privateRegisterChallenge() {
		try {
			...
			if (32 == result_str.length()) {
				this.challengeId = md5Encode(result_str + this.privateKey);
				return 1;
			} else {
